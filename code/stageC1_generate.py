...
def main():
    ...
    checkpoint_path = './results/stageC1/mind-vis/d7xbuiys/checkpoints/epoch=484-step=38800.ckpt'  # FIXME watch out !!
    ...
    wandb_logger = WandbLogger(project='mind-vis',
                            id='d7xbuiys',  # FIXME watch out !!
                            group='stageC1',
                            log_model=False,
                            save_dir=output_root,
                            prefix='test_best_484epoch',  # FIXME watch out !!
                            resume=True
                            )
